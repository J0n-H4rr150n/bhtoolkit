...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/scope-rules": {
            "get": {
                "description": "(Not Implemented Yet) Retrieves all scope rules for a specified target.",
                "produces": [
                    "application/json"
                ],
                "tags": [
            ...
            "post": {
                "description": "(Not Implemented Yet) Adds a new scope rule (in-scope or out-of-scope) to a specified target.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID of the target to add the rule to",
                        "name": "target_id",
                        "in": "query",
                        "required": true
                    },
                    {
                        "description": "Scope rule to add (target_id in body will be ignored, use query param; id and is_wildcard are ignored/auto-set)",
                        "name": "rule",
                        "in": "body",
                        "required": true,
                        "schema": {
